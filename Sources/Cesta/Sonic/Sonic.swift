...
public class Sonic: NSObject, AVAudioPlayerDelegate {
    ...
    public static let shared = Sonic()
    ...
    /// Stops one specific sound file currently being played centrally by Sonic.
    ...
    /// Stops all sounds currently being played centrally by Sonic.
    public func stopAll() {
        for playingSound in playingSounds {
            playingSound.stop()
        }

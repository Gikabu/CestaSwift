...
public struct SonicViewModifier: ViewModifier {
    ...
    private func prepareAudio() {
        ...
        audioPlayer = Sonic.shared.prepare(sound: sound, from: from)
